...
export function updateMonsterAI(state: GameState): GameState {
  ...
  const mergedMonsters = pendingSpawns.length > 0 ? [...monsters, ...pendingSpawns] : monsters
